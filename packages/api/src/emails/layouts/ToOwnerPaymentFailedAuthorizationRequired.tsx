...
export function ToOwnerPaymentFailedAuthorizationRequired({
	...
	const content = {
		...
		messageTwo: {
			fr: "En cas d'absence d'autorisation du paiement de votre part avant la fin de la réservation, nous serons dans l'obligation de faire intervenir un organisme de recouvrement de paiement afin de permettre le paiement du pet sitter.",
			en: 'If you do not authorize payment before the end of the reservation, we will be forced to involve a payment collection agency to allow payment for the pet sitter.'
		},
		link: {
